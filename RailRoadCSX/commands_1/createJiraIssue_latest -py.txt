...
# Usage          : It is automatically triggered on a successful production build.
# Modifications  :
# Ver	Name	   : 1.0
...
################################################################################################
##########  THIS SECTION CREATES  A JIRA ISSUE AFTER A SUCCESSFUL PRODUCTION BUILD  ############
################################################################################################


# JIRA NON-PROD LOGIN
# options={'server': 'http://lnx21256:8080'}
# jira=JIRA(options=options,basic_auth=('<user-id>', '<password>'))
...
################################################################################################
#############  DONE CREATING  A JIRA ISSUE AFTER A SUCCESSFUL PRODUCTION BUILD  ################
################################################################################################
